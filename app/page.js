    ...
    <>
      <main>
        <section className="landingSectionWelcome">
          <div className="txtContainer">
            <div className="txtContent">
              ...
              <h3 className="landingH3">Contact Us Today!</h3>
            </div>
            <div>
              <Image
        ...
        <section className="landingSectionNav">
          ...
          <span>
            <FaWifi size={50} color="#54738e" /> <h1>Amenities</h1>
          </span>

          <span>
            {" "}
            <GiModernCity size={50} color="#54738e" /> <h1>Neighborhood</h1>
          </span>
          <span>
            {" "}
            <FaPhone size={50} color="#54738e" /> <h1>Contact</h1>
          </span>
        </section>
      </main>
    </>
